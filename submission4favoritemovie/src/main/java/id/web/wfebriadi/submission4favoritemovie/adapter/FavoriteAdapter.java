package id.web.wfebriadi.submission4favoritemovie.adapter;
...
import id.web.wfebriadi.submission4favoritemovie.FilmDetailActivity;
import id.web.wfebriadi.submission4favoritemovie.R;
...
import static id.web.wfebriadi.submission4favoritemovie.database.DatabaseContract.FilmColumns.OVERVIEW;
import static id.web.wfebriadi.submission4favoritemovie.database.DatabaseContract.FilmColumns.POSTER;
import static id.web.wfebriadi.submission4favoritemovie.database.DatabaseContract.FilmColumns.RELEASE_DATE;
import static id.web.wfebriadi.submission4favoritemovie.database.DatabaseContract.FilmColumns.TITLE;
import static id.web.wfebriadi.submission4favoritemovie.database.DatabaseContract.getColumnString;
